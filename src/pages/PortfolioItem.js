...
import { faCalendarDays, faWindowRestore } from '@fortawesome/free-regular-svg-icons';
import { faCode, faDesktop, faLightbulb } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { useParams } from 'react-router-dom';
import { FullBtn } from '../components/StyledComponent';
...
const item = {
  themeChange : {
    ...
    skill : 'React.js',
    source : 'https://github.com/yeon7513/theme-change',
    demo : 'https://tranquil-monstera-10e97e.netlify.app' 
  },
  top100List : {
    gif : 'top',
    title : '100대 리스트',
    ...
    source : 'https://github.com/yeon7513/Database-Input-And-Output',
    demo : 'https://github.com/yeon7513' 
  },
  searchAPI : {
    gif : 'search',
    title : '검색 API',
    ...
    skill : 'React.js',
    source : 'https://github.com/yeon7513/search-api-project',
    demo : 'https://github.com/yeon7513' 
  },
  matchingCard : {
    gif : 'card',
    ...
    demo : 'https://tiny-monstera-fa6648.netlify.app/' 
  },
  myTodolist : {
    gif : 'td',
    title : 'MY TODOLIST',
    ...
    demo : 'https://strong-cannoli-6db1d9.netlify.app/' 
  },
  movieApp : {
    /* gif : 'movie', */
    title : '영화 검색 앱',
    ...
    date : '2023.?? - 2023.??',
    skill : 'React.js',
    source : 'https://github.com/yeon7513',
    demo : 'https://github.com/yeon7513' 
  },
  _3MatchPuzzle : {
    /* gif : 'puzzle', */
  ...
  teamProject : {
    ...
    source : 'https://github.com/yeon7513/team-Project-Apple-Store-RENEWAL',
    demo : 'https://yeon7513.github.io/team-Project-Apple-Store-RENEWAL/' 
  }
};
            ...
            <div className='work-contents'>
              <div className="glass-box">
                ...
                <div className="goto-btn">
                  <ul>
                    <li>
                      <FullBtn href={myPF.source} target='_blank'>
                        <FontAwesomeIcon icon={faCode} />
                        <span className='tooltip'>Source</span>
                      </FullBtn>
                    </li>
                    <li>
                      <FullBtn href={myPF.demo} target='_blank'>
